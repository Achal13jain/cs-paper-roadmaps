...
- Accepting responsibility, apologising for mistakes, and learning from them
- Focusing on what is best for the community as a whole

Examples of unacceptable behaviour:

- The use of sexualised language or imagery, and sexual attention of any kind
...
requests, discussions, the project's chat (if any) — and also applies when
...
- A private security advisory: https://github.com/Achal13jain/cs-paper-roadmaps/security/advisories/new
